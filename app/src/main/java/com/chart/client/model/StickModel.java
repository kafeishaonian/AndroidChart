...
public class StickModel implements Parcelable {
    ...
    public StickModel(double maValue) {
    ...
    protected StickModel(Parcel in) {
    ...
    public static final Creator<StickModel> CREATOR = new Creator<StickModel>() {
        @Override
        public StickModel createFromParcel(Parcel source) {
            return new StickModel(source);
        }

        @Override
        public StickModel[] newArray(int size) {
            return new StickModel[size];
        }
    };
}
