...
public class ColorUtil {
     ...
     * @return
     */
    public static String getCurPriceInfo(CMinute cMinute, double yd){
        StringBuffer buffer = new StringBuffer();
        buffer.append("   " + cMinute.getTimeStr());
        if (cMinute.getPrice() >= yd){
            buffer.append("  价格" + "<font color='#e36d50'>" + NumberUtil.beautifulDouble(cMinute.getPrice()) + "</font>");
        } else {
            buffer.append("  价格" + "<font color='#3b7f19'>" + NumberUtil.beautifulDouble(cMinute.getPrice()) + "</font>");
        }

        if (cMinute.getRate() >= 0){
            buffer.append("  涨幅" + "<font color='#e36d50'>" + NumberUtil.beautifulDouble(cMinute.getRate()) +"%</font>");
        } else {
            buffer.append("  涨幅" + "<font color='#3b7f19'>" + NumberUtil.beautifulDouble(cMinute.getRate()) +"%</font>");
        }

        buffer.append("  成交" + cMinute.getCount());
        if (cMinute.getAverage() >= yd){
            buffer.append("  均价" + "<font color='#e36d50'>" + NumberUtil.beautifulDouble(cMinute.getAverage()) +"</font>");
        } else {
            buffer.append("  均价" + "<font color='#3b7f19'>" + NumberUtil.beautifulDouble(cMinute.getAverage()) +"</font>");
        }
    ...
    public static String getCurPriceInfo(StickModel entity) {
        StringBuffer sb = new StringBuffer();
