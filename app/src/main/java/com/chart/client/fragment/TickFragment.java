...
import com.chart.client.ui.CrossView;
import com.chart.client.ui.TickChartView;
...
public class TickFragment extends LineBaseFragment {
    ...
    private TickChartView fenshiView;
    private CrossView crossView;
    //滑动十字线时，显示对应点详情的地方
    private TextView msgText;
    //分时数据
    private TickDataResponse data;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        data = new Gson().fromJson(sb.toString(), TickDataResponse.class);
        return inflater.inflate(R.layout.chart_tick_fragment, null);
    }
    ...
    private void findViews() {
        ...
        fenshiView = (TickChartView) getView().findViewById(R.id.cff_fenshiview);
